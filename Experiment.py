...
def experiment():
    ...
    single_goal_locations = [[7, 3]]
    single_goal_rewards = [100]

    multi_goal_locations = [[7, 3], [3, 2]]
    multi_goal_rewards = [100, 5]
    ...
    Plot = LearningCurvePlot(title=r'Single Target Exploration: $\epsilon$-greedy versus softmax exploration')
